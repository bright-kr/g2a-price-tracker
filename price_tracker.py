"""
G2A Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from G2A.

Docs  : https://docs.brightdata.co.kr/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.co.kr/products/insights/price-tracker/g2a
"""
...
# Set your Web Scraper ID after building your G2A scraper:
# https://brightdata.co.kr/products/web-scraper/g2a
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your G2A scraper at: https://brightdata.co.kr/products/web-scraper/g2a\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of G2A product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover G2A products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a G2A category page.

    Example:
        results = discover_by_category("https://g2a.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.g2a.com/product/sample-item-123456",
        # Add more G2A product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "g2a_prices.json"
    ...
    # cat_results = discover_by_category("https://g2a.com/category/sample", limit=50)
